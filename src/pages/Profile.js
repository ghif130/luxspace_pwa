...
function Profile(){
    function subscribe() {
        const keyPublic = 'BE2ZpIA9cuCtZIgBuMkMuHUeowSUYO4iWHge19q3sp191thgDA9_6gH0-z_qKv4tlgOoDQJiCyg0tazd_AALo94'
        const keyPrivate = 'fIAwoXnbNxopbJZTL2knJGQO40BkCES-BfJszvSXizQ'

        try{
            (async ()=> { await global.registration.pushManager.subscribe({
                    userVisibleOnly: true,
                    applicationServerKey: urlB64ToUint8Array(keyPublic)
                })
